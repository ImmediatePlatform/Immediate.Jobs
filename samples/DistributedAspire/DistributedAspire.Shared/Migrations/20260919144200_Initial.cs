...
public sealed partial class Initial : Migration
{
	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_BatchableRows", x => x.Id));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_immediate_fair_queue_groups", x => new { x.QueueName, x.GroupId }));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_immediate_job_batches", x => x.Id));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_immediate_job_servers", x => x.WorkerId));
		...
		migrationBuilder.CreateTable(
			...
			constraints: table => table.PrimaryKey("PK_immediate_recurring_jobs", x => x.Name));
		...
		migrationBuilder.CreateIndex(
			...
			table: "immediate_jobs",
			columns: ["QueueName", "State", "DueAt", "CreatedAt"]);

		migrationBuilder.CreateIndex(
			name: "IX_immediate_jobs_QueueName_State_GroupId",
			table: "immediate_jobs",
			columns: ["QueueName", "State", "GroupId"]);
