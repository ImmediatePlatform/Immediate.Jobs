...
#error .net version not yet implemented
	...
	[
		MetadataReference.CreateFromFile(typeof(JobAttribute).Assembly.Location),
		...
		.. (IEnumerable<MetadataReference>)(includeNodaTime switch
		{
			true => [
				MetadataReference.CreateFromFile(typeof(NodaTime.NodaTimeJobSerializer).Assembly.Location),
